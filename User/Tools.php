   ...
   switch ($_GET["action"]) {
      case "add":
         if (!empty($_POST["quantity"])) {
            $query = "SELECT * FROM Medicine WHERE  MedName='" . $_GET["MedName"] . "' and MedCategory='Tools'";
   ...
   <div class="clothes_main section ">
      <div class="container">
         <div class="row">
            ...
            $sql = "Select * From Medicine  where MedCategory='Tools' order by MedName;";
            ...
            ?>
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                     <div class="sport_product">
                        <form method="post" action="Tools.php?action=add&MedName=<?php echo $product_array[$key]["MedName"]; ?>">
      ...
      <span id="navspan">
         ...
         <div id="shopping-cart" style="padding: 20px;">
            <form class="shopcart" method="$_POST" action="Checkout.php">
               ...
               <a id="btnEmpty" href="Tools.php?action=empty">Empty Cart</a>
               <?php
                        ...
                        ?>
                           <tr>
                              ...
                              <td style="text-align:center;">
                                 <a href="Tools.php?action=remove&MedName=<?php echo $item["MedName"]; ?>" class="btnRemoveAction">
