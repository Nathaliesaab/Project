   ...
   switch ($_GET["action"]) {
      case "add":
         if (!empty($_POST["quantity"])) {
            $query = "SELECT * FROM Medicine WHERE  MedName='" . $_GET["MedName"] . "'";
            ...
            ?>
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                     <div class="sport_product">
                        <form method="post" action="clients.php?action=add&MedName=<?php echo $product_array[$key]["MedName"]; ?>">
      ...
      <span id="navspan">
         ...
         <div id="shopping-cart" style="padding: 20px;">
            <form class="shopcart" method="$_POST" action="Checkout.php">
               ...
               <a id="btnEmpty" href="clients.php?action=empty">Empty Cart</a>
               <?php
                  ...
                  <div class="table-responsive">
                     <table class="table table-bordered">
                        ...
                        ?>
                           <tr>
                              ...
                              <td style="text-align:center;">
                                 <a href="clients.php?action=remove&MedName=<?php echo $item["MedName"]; ?>" class="btnRemoveAction">
                        ...
                        <tr>
                           ...
                           <td align="center" colspan="1"><strong><?php echo "$ " . number_format($total_price, 2); ?></strong></td>
